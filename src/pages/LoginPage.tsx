        ...
        <div className="hidden lg:block animate-in fade-in-0 slide-in-from-left-6 duration-500">
          <div className="max-w-lg">
            ...
            <p className="mt-3 text-muted-foreground">
              {t("loginSideDescription")}
            </p>

            <div className="mt-8 grid gap-3 text-sm text-muted-foreground">
              <div className="rounded-2xl border bg-background/40 p-5 backdrop-blur-sm">
                <p className="font-medium text-foreground">
                  {t("loginSidePoint1Title")}
                </p>
                <p className="mt-1">{t("loginSidePoint1Desc")}</p>
              </div>
              <div className="rounded-2xl border bg-background/40 p-5 backdrop-blur-sm">
                <p className="font-medium text-foreground">
                  {t("loginSidePoint2Title")}
                </p>
                <p className="mt-1">{t("loginSidePoint2Desc")}</p>
              </div>
              <div className="rounded-2xl border bg-background/40 p-5 backdrop-blur-sm">
                <p className="font-medium text-foreground">
                  {t("loginSidePoint3Title")}
                </p>
                <p className="mt-1">{t("loginSidePoint3Desc")}</p>
              </div>
            </div>
          </div>
        </div>
